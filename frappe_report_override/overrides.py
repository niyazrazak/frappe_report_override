...
def get_script(report_name):
	...
	if report_override_js.get(report_name):
		script_path = os.path.join(frappe.get_app_path("frappe_report_override"), report_override_js.get(report_name)[0])
	else:
	...
	if report_override_html.get(report_name):
		print_path = os.path.join(frappe.get_app_path("frappe_report_override"), report_override_html.get(report_name)[0])
	else:
